...
export default async function callGroq(inputString){
    ...
    let quizCards = await generateQuiz(inputString)
...
let string = "Write a reasonable number of question to cover these notes that a student has written: " + user_notes;
...
//Old function version, see above for current version 
/* 
